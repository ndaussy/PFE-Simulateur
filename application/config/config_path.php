...
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
    ...
    $config['config_path_prog_register'] = 'start java -jar C:/wamp/www/PFE-Simulateur/application/prog_C/GpsRegister.jar';
    $config['config_path_prog_gps'] = 'start java -jar C:/wamp/www/PFE-Simulateur/application/prog_C/SendDataGps.jar';
} else {
